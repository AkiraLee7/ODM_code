...
def Get_Channel(Img_Size, Filling_Type, Object_Color_0):
    _Channel_Color = np.zeros(Img_Size)
    color_Type_0 = random.randint(0,1)
    if color_Type_0 == 0:
        Color_Start = random.randint(Object_Color_0 + 15, 255)
        Color_End = random.randint(Object_Color_0 + 15, 255)
    elif color_Type_0 == 1:
        Color_Start = random.randint(0, Object_Color_0 - 15)
        Color_End = random.randint(0, Object_Color_0 - 15)
    else:
