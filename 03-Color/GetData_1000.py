...
def Get_Channel(Img_Size, Filling_Type):
    _Channel_Color = np.zeros(Img_Size)
    Color_Start = random.randint(0, 255)
    Color_End = random.randint(0, 255)
    if Filling_Type == 0:
...
def Get_Image(Img_Size, Edge_Dis):
    ...
    Channel_Color_0 = Get_Channel(Img_Size, Filling_Type_0)
    Channel_Color_1 = Get_Channel(Img_Size, Filling_Type_1)
    Channel_Color_2 = Get_Channel(Img_Size, Filling_Type_2)
    Object_Color_0 = random.randint(0,255)
    Object_Color_1 = random.randint(0,255)
    Object_Color_2 = random.randint(0,255)
...
def main():
    ...
    Filename2 = 'Output/Target_1000.txt'
    Filename3 = 'Output/Target_Config_1000.txt'
    Img_Number = 10000
    Img_Height = 1000
    Img_Width = 1000
    Edge_Dis = 2
